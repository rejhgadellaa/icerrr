...
site.vars.fadeIns[selector].timeout=setTimeout(function(){site.vars.fadeIns[selector].timeout=setTimeout(function(){loggr.log(" -> fadeIn "+selector+" transitionend",{dontsave:true});if(jqobj.css("opacity")<=0.9){loggr.warn(" -> opacity<=0.9?! "+selector+" transitionend",{dontsave:true});}
...
site.vars.fadeOuts[selector].timeout=setTimeout(function(){site.vars.fadeOuts[selector].timeout=setTimeout(function(){loggr.log(" -> fadeOut "+selector+" transitionend",{dontsave:true});if(jqobj.css("opacity")>=0.1){loggr.warn(" -> opacity<=0.9?! "+selector+" transitionend",{dontsave:true});}
