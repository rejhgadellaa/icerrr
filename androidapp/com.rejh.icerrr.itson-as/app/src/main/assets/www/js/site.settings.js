...
site.settings.helpSLS = function() {
	loggr.log("site.settings.helpSLS()");
	var title = "Help: Settings";
	var buttonName = "OK";
	var message = ""
		+"Simple Last.fm Scrobbler integration\n\n"
		+"Scrobbling a song means that when you listen to it, the name of the song is sent to Last.fm and added to your music profile. Once you've signed up to Last.fm, you can scrobble songs you listen to in the Radio.com app automatically. Start scrobbling yourself and see what artists you really listen to the most.\n\n"
		+"Source: Google"
		;
	navigator.notification.alert(message, function(){}, title, buttonName)
}
